...
static std::map<std::string,Cookie> userCookies;

responseType Server::insertCookie(const std::string username, Cookie& cookie){
...
responseType Server::getCookie(const std::string username, Cookie& cookie){
...
responseType Server::updateCookie(const std::string username){  //aggiorna solo "birthday" del cookie
    WriteLock w_lock(cookielock);
...
responseType Server::updateCookie(const std::string username, const Cookie& cookie){  //aggiorna "data" e "birthday" del cookie
    WriteLock w_lock(cookielock);
...
responseType Server::isValid(const std::string username, const Cookie& cookie){
    ReadLock r_lock(cookielock);
